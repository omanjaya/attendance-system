                ...
                <div class="row">
                  <div class="col-12">
                    <div class="mb-3">
                      ...
                      <div class="form-hint" v-if="selectedTypeConfig?.description">
                        {{ selectedTypeConfig.description }}
                      </div>
                      <div class="invalid-feedback" v-if="errors.employee_type" role="alert">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="mb-3">
                ...
                >
                <div id="employee-id-error" class="invalid-feedback" v-if="errors.employee_id" role="alert">
                  {{ errors.employee_id }}
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="mb-3">
                ...
                >
                <div id="employee-name-error" class="invalid-feedback" v-if="errors.name" role="alert">
                  {{ errors.name }}
                </div>
              </div>
            </div>
              ...
              <template v-if="isHourlyBased">
                ...
                <div class="mt-4 d-flex justify-content-between">
                  ...
                  >
                    ...
                    <svg v-else xmlns="http://www.w3.org/2000/svg" class="icon me-2" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                      <path d="M12 5l0 14"/>
                      <path d="M5 12l14 0"/>
                    </svg>
...
const submitForm = async () => {
  ...
  const result = await submitWithLoading('create-employee', async () => {
...
watch(() => form.employee_type, (newType) => {
...
onMounted(() => {
  ...
  // Add skip links
  skipLinks.addToPage([
    { target: 'employee-form', text: 'Skip to employee form' }
  ])
