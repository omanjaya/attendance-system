<template>
  <div class="page-body">
    <div class="container-xl">
      <div class="page-header d-print-none" v-if="employee">
      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-auto">
                <span class="avatar avatar-xl" :style="employee.avatar_url ? `background-image: url(${employee.avatar_url})` : ''">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <dl class="row">
              ...
              <dd class="col-7"><span class="badge bg-azure-lt">{{ employee.employee_id }}</span></dd>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="btn-list">
              ...
              <button @click="toggleStatus" class="btn" :class="employee.is_active ? 'btn-warning' : 'btn-success'">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <circle cx="12" cy="12" r="10"/>
...
const isTeacher = computed(() => {
  ...
  return employee.value.employee_type === EMPLOYEE_TYPES.GURU_TETAP || 
         employee.value.employee_type === EMPLOYEE_TYPES.GURU_HONORER
})

const isStaff = computed(() => {
  if (!employee.value) return false
  return employee.value.employee_type === EMPLOYEE_TYPES.TENAGA_KEPENDIDIKAN || 
