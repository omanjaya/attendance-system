...
export class SessionPersistenceTest {
  ...
  async testTokenPersistence() {
    try {
      ...
      this.addTestResult('Token Persistence', isTokenRestored, 
  ...
  async testUserDataPersistence() {
    try {
      ...
      const isUserRestored = this.authStore.user && 
                           this.authStore.user.name === testUser.name &&
                           this.authStore.user.email === testUser.email
      
      this.addTestResult('User Data Persistence', isUserRestored, 
  ...
  async testAuthStateInitialization() {
    try {
      ...
      this.addTestResult('Auth State Initialization', isInitialized && hasToken, 
  ...
  async testRouterGuardBehavior() {
    try {
      ...
      this.addTestResult('Router Guard Behavior', isAuthenticated && isUnauthenticated, 
  ...
  async testTokenValidationOnReload() {
    try {
      ...
      this.addTestResult('Token Validation on Reload', authHeaderSet && axiosHeaderSet, 
