          ...
          <ul class="dropdown-menu">
            <li>
              <a 
                class="dropdown-item" 
                href="#" 
                @click.prevent="handleBulkAction('activate')"
              >
            ...
            <li>
              <a 
                class="dropdown-item" 
                href="#" 
                @click.prevent="handleBulkAction('deactivate')"
              >
...
const selectedEmployeesList = computed(() => {
  return selectedEmployees.value.map(id => 
    employeeStore.byId(id)
  ).filter(Boolean)
})
...
// Watchers
watch(() => employeeStore.error, (error) => {
  if (error) {
    showNotification({
      type: 'error',
      title: 'Error',
