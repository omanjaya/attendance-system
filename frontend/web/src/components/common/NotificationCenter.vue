      ...
      <div class="card">
          ...
          <div class="card-actions">
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end">
                <a class="dropdown-item" href="#" @click.prevent="markAllAsRead" v-if="unreadCount > 0">
        ...
        <div class="card-body p-0" style="max-height: 400px; overflow-y: auto;">
          ...
          <div v-if="!isConnected" class="alert alert-warning m-3 mb-0">
            <div class="d-flex">
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon alert-icon">
