...
- [ ] DNS A record configured for main domain
- [ ] DNS A record configured for www subdomain (if needed)
...
### 2. Clone Project
```bash
git clone https://github.com/yourusername/attendance-system.git ~/attendance-system
